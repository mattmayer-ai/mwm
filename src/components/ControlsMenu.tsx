      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content className="min-w-[220px] rounded-[10px] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-2 shadow-xl z-50">
            ...
            <DropdownMenu.Item 
              asChild 
              className="how-ai-works-item outline-none border-0 focus:outline-none focus:ring-0 hover:border-0"
            >
              <button
                onClick={() => setTrustOpen(true)}
                className="flex w-full items-center gap-2 rounded-[10px] px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-brand-blue hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-blue/40 active:outline-none transition-colors border-0"
              >
